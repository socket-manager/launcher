 ...
 */
class ParameterForStressTest extends ParameterForBenchmark
{
    //--------------------------------------------------------------------------
    // 定数（first byte）
    //--------------------------------------------------------------------------
     ...
     */
    public function __construct(int $p_samples, int $p_sampling_interval, ?bool $p_tls = null)
    {
        parent::__construct();
     ...
     */
    public function forcedCloseFromClient(ParameterForBenchmark $p_param)
    {
    }
}
